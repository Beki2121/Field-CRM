...
/* Domain constants                                                   */
/* ---------------------------------------------------------------- */
export const SECTORS = ["Pharmacy", "Cosmetics & Beauty", "Mini-Market", "Supermarket", "Perfume", "Mart / General Retail", "Other"];
export const BUSINESS_STATUSES = ["Lead", "Interested", "Maybe", "Customer", "One-Time Customer", "Not Interested", "Lost"];
export const SALES_STAGES = ["New Lead", "Contacted", "Demo Scheduled", "Demo Completed", "Trial", "Negotiation", "Ready to Buy", "Customer", "One-Time Customer", "Lost", "Not Interested"];
export const CONTACT_METHODS = ["On-site", "Phone", "WhatsApp", "Online", "Other"];
export const INTEREST_STATUSES = ["Interested", "Maybe", "Not Interested", "Existing Customer"];
export const NEXT_ACTIONS = ["Call", "WhatsApp", "Visit", "Demo", "Send Price", "Start Trial", "Setup", "Follow Up", "No Action"];
...
/* Soft cap for the frontend-only / localStorage phase. Not a hard limit —
   just a signal to move to a real backend once you're consistently near it. */
