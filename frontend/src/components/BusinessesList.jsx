...
import { Search, Filter, Plus, Users, Trash2 } from "lucide-react";
import {
  C,
  SECTORS,
  BUSINESS_STATUSES,
  ...
  return (
    <div>
      ...
      {nearCap && (
        ...
        >
          {businesses.length}/{RECORD_SOFT_CAP} businesses stored in the
          database. Consider archiving old records if you need more space.
        </div>
      )}
      ...
      <div className="relative mb-2.5">
        <Search
          size={15}
          style={{ position: "absolute", left: 11, top: 12, color: C.inkFaint }}
        />
        <TextInput
          value={query}
      ...
      >
        ...
        {(sectorFilter || statusFilter) && "· active"}
      </button>
      ...
      {filtered.length === 0 ? (
        <Card>
          <EmptyState
            ...
            body="Try a different search, or add a new business."
          />
        </Card>
      ) : (
